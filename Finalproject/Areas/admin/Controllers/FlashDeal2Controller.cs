                ...
                if (flashDeal2.ImageFile != null)
                {
                    if (flashDeal2.ImageFile.ContentType == "image/jpeg" || flashDeal2.ImageFile.ContentType == "image/png")
                    {
                        if (flashDeal2.ImageFile.Length <= 3000000)
                        {
                            ...
                            string FilePath = Path.Combine(_webHostEnvironment.WebRootPath, "Uploads3", FileName);
                ...
                if (ModelState.IsValid)
                {
                    if (flashDeal2.ImageFile != null)
                    {
                        if (flashDeal2.ImageFile.ContentType == "image/jpeg" || flashDeal2.ImageFile.ContentType == "image/png")
                        {
                            if (flashDeal2.ImageFile.Length <= 3000000)
                            {
                                string olddata = Path.Combine(_webHostEnvironment.WebRootPath, "Uploads3", flashDeal2.Image);
