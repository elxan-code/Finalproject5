                ...
                if (homeImage1.ImageFile != null)
                {
                    if (homeImage1.ImageFile.ContentType == "image/jpeg" || homeImage1.ImageFile.ContentType == "image/png")
                    {
                        if (homeImage1.ImageFile.Length <= 3000000)
                        {
                            ...
                            string FilePath = Path.Combine(_webHostEnvironment.WebRootPath, "Uploads1", FileName);
            ...
            if (ModelState.IsValid)
            {
                if (homeImage1.ImageFile != null)
                {
                    if (homeImage1.ImageFile.ContentType == "image/jpeg" || homeImage1.ImageFile.ContentType == "image/png")
                    {
                        if (homeImage1.ImageFile.Length <= 3000000)
                        {
                            string olddata = Path.Combine(_webHostEnvironment.WebRootPath, "Uploads1", homeImage1.Image);
